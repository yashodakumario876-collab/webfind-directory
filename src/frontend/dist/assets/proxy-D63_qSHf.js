...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, e as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, f as RequestStatusResponseStatus, U as UnknownError, g as RequestStatusDoneNoReplyErrorCode, h as RejectError, i as CertifiedRejectErrorCode, k as UNREACHABLE_ERROR, I as InputError, m as InvalidReadStateRequestErrorCode, n as ReadRequestType, o as Principal, p as IDL, q as MissingCanisterIdErrorCode, H as HttpAgent, s as encode, Q as QueryResponseStatus, t as UncertifiedRejectErrorCode, v as isV3ResponseBody, w as isV2ResponseBody, x as UncertifiedRejectUpdateErrorCode, y as UnexpectedErrorCode, z as decode, A as Subscribable, B as pendingThenable, D as resolveEnabled, F as shallowEqualObjects, G as resolveStaleTime, J as noop$1, K as environmentManager, N as isValidTimeout, O as timeUntilStale, V as timeoutManager, W as focusManager, X as fetchState, Y as replaceData, Z as notifyManager, _ as hashKey, $ as getDefaultState, r as reactExports, a0 as shouldThrowError, a1 as useQueryClient, a2 as useInternetIdentity, a3 as createActorWithConfig, j as jsxRuntimeExports, b as React, a4 as clsx, c as cn, L as Link, a5 as Record, a6 as Vec, a7 as Service, a8 as Func, a9 as Text, aa as Opt, ab as Nat, ac as Int } from "./index-Dyou9ZIE.js";
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border sticky top-0 z-50 shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary flex items-center justify-center shadow-xs group-hover:shadow-md transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Earth, { size: 18, className: "text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl text-foreground", children: "WebFind" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground font-body tracking-wide", children: "भारत की डिजिटल दुनिया" })
            ] })
          ]
        }
      ),
        ...
        "nav",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              ...
              "data-ocid": "nav-home",
              children: "Discover (खोजें)"
            }
          )
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/submit", "data-ocid": "nav-submit", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "btn-primary flex items-center gap-2 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 15 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Submit Website" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Submit" })
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 bg-background", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-6xl mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 12, className: "text-primary-foreground" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "hover:text-foreground transition-colors", children: "Discover (खोजें)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/submit",
            className: "hover:text-foreground transition-colors",
            children: "Submit Site (जोड़ें)"
          }
        )
      ] })
    ] }) }) })
...
Service({
  "getAllWebsites": Func([], [Vec(Website)], ["query"]),
  "getCategories": Func([], [Vec(Text)], ["query"]),
  "getWebsiteById": Func([WebsiteId], [Opt(Website)], ["query"]),
  "searchWebsites": Func(
    [Text, Opt(Text)],
    [Vec(Website)],
    ["query"]
  ...
  "submitWebsite": Func(
    [Text, Text, Text, Text, Vec(Text)],
    [Website],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  const WebsiteId2 = IDL2.Nat;
  const Website2 = IDL2.Record({
    "id": WebsiteId2,
    "url": IDL2.Text,
    "name": IDL2.Text,
  ...
  return IDL2.Service({
    "getAllWebsites": IDL2.Func([], [IDL2.Vec(Website2)], ["query"]),
    "getCategories": IDL2.Func([], [IDL2.Vec(IDL2.Text)], ["query"]),
    "getWebsiteById": IDL2.Func([WebsiteId2], [IDL2.Opt(Website2)], ["query"]),
    "searchWebsites": IDL2.Func(
      [IDL2.Text, IDL2.Opt(IDL2.Text)],
      [IDL2.Vec(Website2)],
      ["query"]
    ),
    "submitWebsite": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Vec(IDL2.Text)],
      [Website2],
      []
    )
  });
...
class Backend {
  ...
  async searchWebsites(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async submitWebsite(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
...
function useWebsiteById(id2) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["website", id2 == null ? void 0 : id2.toString()],
    queryFn: async () => {
      if (!actor || id2 === void 0) return null;
      const result = await actor.getWebsiteById(id2);
      return result ?? null;
    },
